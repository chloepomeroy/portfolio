...
export default function About() {
    var instagram = <Link class="about-link" to="https://www.instagram.com/loslittlebuddies/">Instagram Page</Link>
    var etsy = <Link class="about-link" to="https://loslittlebuddies.etsy.com">Etsy Store</Link>
    var youtube = <Link class="about-link" to="https://www.youtube.com/channel/UCBFSoJrW8wPAUmX5i-nQYqw">Youtube</Link>

    return (
        <Grid container xs={12} spacing={1} padding={2} sx={{ justifyContent: "center" }}>
            <Grid item xs={1}></Grid>
            ...
            <Grid item xs={2} sx={{ justifyContent: "left" }}>
            ...
            <Grid item xs={6} sx={{ justifyContent: "left", textAlign: "left" }}>
                ...
                <Typography marginBottom={1}>
                    Hi! I'm Chloe and I live in Ottawa, Ontario, Canada with my partner and our 2 cats, Little Rascal and Cappucino.
                </Typography>
                <Typography marginBottom={1}>
